    ...
    <div id="all">
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        <li><a href="addcust&emp.html">Employee Section</a>
                        </li>
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="checkout1.html">
                            ...
                            <p class="text-muted">Place an order for a customer </p>

                            <div class="table-responsive">
                                <h2> Select a category</h2>
                                <a href="Engagement.php"><li> Engagement</li></a>
                                <a href="Jewellery.php"><li> Jewellery </li></a>
                                <a href="Watches.php"><li> Watches </li></a>
                                <a href="Gifts.php"><li> Gifts</li></a>
                            </div>
                            <!-- /.table-responsive -->

                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="createOrders.php" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
