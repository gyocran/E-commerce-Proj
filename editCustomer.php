        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        <li><a href="editcust&emp.html">Employee Section </a>
                        </li>
...
<html>
    ...
    <body>
    <form action="editCustomer.php" method="GET" onsubmit='validate()'>
    <div>
            <div>cno: <input type="text" value="<?php echo $cno ?>" name="cno"/></div>
            ...
            <div>street: <input type="text" value="<?php echo $street ?>"  name="street"/></div>
            <div>phone: <input type="text" value="<?php echo $phone ?>" name="phone"/></div>
            <div>email_address: <input type="password" value="<?php echo $email_address ?>" name="email_address"/></div>
            </div>
...
<?php
    if (isset($_REQUEST['up']))
    {
        ...
        $result1= $user-> editCustomer($cno, $fname, $lname, $street, $phone, $email_address);
        if (!$result1){
