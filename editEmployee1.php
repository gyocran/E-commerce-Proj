        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        <li><a href="editcust&emp.php">Employee Section</a>
                        </li>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-orders">
                    <div class="box">
                        ...
                        <p class="lead">Enter the details of the new employee</p>
                        <hr>
...
<html>
    ...
    <body>
    <form action="editEmployee1.php" method="GET" onsubmit='validate()'>
    <div>
            <div>eno: <input type="text" value="<?php echo $eno ?>" name="eno"/></div>
            <div>fname: <input type="text" value="<?php echo $fname ?>" name="fname"/></div>
            <div>lname: <input type="text" value="<?php echo $lname ?>" name="lname"/></div>
            <div>email_address: <input type="text" value="<?php echo $email_address ?>"  name="email_address"/></div>
            <div>phone_number: <input type="text" value="<?php echo $phone_number ?>" name="phone_number"/></div>
            <div>home_address: <input type="password" value="<?php echo $home_address ?>" name="home_address"/></div>
                <div>hdate: <input type="password" value="<?php echo $hdate ?>" name="hdate"/></div>
            </div>
...
<?php
    if (isset($_REQUEST['up']))
    {
        ...
        $result1= $user-> editEmployee($eno, $fname, $lname, $email_address, $phone_number, $home_address, $hdate );
        if (!$result1){
