...
<head>
    ...
    <title>
        Select an Engagement Jewellery
    </title>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="Engagement.php">Engagement Rings</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    <div id="all">
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        <li><a href="createOrders.php">Create an Order</a>
                        </li>
                        <li>Engagement</li>
                    </ul>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="box">
                        <h1>Engagement</h1>
                        <p>In our Engagment department we offer wide selection of the best of wedding and enagagement rings, wedding bands and bridal jewellery carefully selected from designers worldwide.</p>
                    </div>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3>Jeff Cooper Luxury Ring</h3>
                                    <p class="price">$2500.00</p>
                                    <p class="buttons">
                                      
                                        <a href="ItemsBought.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Order</a>
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3>Gabriel & Co Diamond Ring</h3>
                                    <p class="price"><del>$280</del> $143.00</p>
                                    <p class="buttons">
                                       
                                        <a href="item2.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Order</a>
                                    </p>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3>Tiffany & Co Classic</h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                       
                                        <a href="basket.html" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Order</a>
                                    </p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3>Tiffany & Co Classic Men</a></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3>Cerrone Engagement Ring</a></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Tungsten Black Rings</a></h3>
