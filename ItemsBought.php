            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                            ...
                            <p class="text-muted">An item has been purchased.</p>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="#">
                                                    <img src="img/detail1.jpg" alt="White Blouse Armani">
                                                </a>
                                            </td>
                                            <td>name</a>
                                            </td>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="Engagement.php" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
                                <div class="pull-right">
                                   <input type=button onClick="parent.location='custDetails.php'" value='Enter Customer Details'>
                                    <!--<button type="submit" class="btn btn-primary">Enter Customer Details <i class="fa fa-chevron-right"></i> -->
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="row same-height-row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product same-height">
                                ...
                                <a href="engagement.php" class="invisible">
                                    <img src="img/product3.jpg" alt="" class="img-responsive">
                                </a>
