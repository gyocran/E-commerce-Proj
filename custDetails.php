...
Description : This page allows the employees to enter the details of customers when creating an order for that customer 
-->
<!DOCTYPE html>
<html lang="en">
...
if(isset($_REQUEST['fname'])){
    ...
    $obj=new users();
     $r=$obj->addCustomers($fname, $lname, $street, $phone, $email);
